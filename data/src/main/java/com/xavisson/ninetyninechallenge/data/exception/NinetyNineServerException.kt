...
class NinetyNineServerException(
        message: String,
        private val response: Response<*>?,
        throwable: Throwable
) : IOException(message, throwable) {
    companion object {
        fun httpError(throwable: HttpException): NinetyNineServerException {
            val response = throwable.response()
            val message = response.code().toString() + " " + response.message()
            return NinetyNineServerException(message, response, throwable)
        }

        fun networkError(exception: Throwable): NinetyNineServerException {
            return NinetyNineServerException(exception.message!!, null, exception)
        }

        fun undefinedError(exception: Throwable): NinetyNineServerException {
            return NinetyNineServerException(exception.message!!, null, exception)
        }
    }
